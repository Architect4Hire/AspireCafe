...
namespace AspireCafe.KitchenApiDomainLayer.Data
{
    public class Data : IData
    {
        ...
        public Data(KitchenContext context)
        {
            _context = context;
        }
        ...
        public async Task<ProcessingOrderDomainModel> AddOrderAsync(ProcessingOrderDomainModel order)
        {
            ...
            order.History = new List<OrderProcessingStatusHistory>() { new OrderProcessingStatusHistory() { CurrentStation = OrderProcessStation.Expo, EntryTime = DateTime.UtcNow } };
